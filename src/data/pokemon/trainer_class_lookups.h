const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_GIOVANNI] = TRAINER_PIC_GIOVANNI
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_ROCKET_GRUNT_M] = TRAINER_CLASS_ROCKET,
    [FACILITY_CLASS_ROCKET_GRUNT_F] = TRAINER_CLASS_ROCKET,
    [FACILITY_CLASS_GIOVANNI] = TRAINER_CLASS_ROCKET_LEADER
};
