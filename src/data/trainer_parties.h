...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_THROW, MOVE_FLAIL, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LOW_KICK, MOVE_SCRATCH, MOVE_KARATE_CHOP, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 19,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_WILL_O_WISP, MOVE_QUICK_ATTACK, MOVE_ATTRACT}
    },
    {
    .iv = 250,
    .lvl = 26,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLASH, MOVE_FURY_SWIPES, MOVE_FACADE, MOVE_LEER}
    },
    {
    .iv = 250,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_REFLECT, MOVE_PSYCHIC, MOVE_RECOVER, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 42,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MEDITATE, MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_DISABLE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FURY_SWIPES, MOVE_CONFUSION, MOVE_CALM_MIND, MOVE_WATER_PULSE}
    },
    {
    .iv = 200,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .species = SPECIES_SUDOWOODO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FLAIL, MOVE_BLOCK, MOVE_LOW_KICK}
    },
    {
    .iv = 255,
    .lvl = 35,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAGE, MOVE_SEISMIC_TOSS, MOVE_KARATE_CHOP, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 35,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .species = SPECIES_PRIMEAPE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAGE, MOVE_SEISMIC_TOSS, MOVE_CROSS_CHOP, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPARK, MOVE_THUNDER, MOVE_WATER_GUN, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 255,
    .lvl = 38,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = {
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPARK, MOVE_THUNDER, MOVE_HYDRO_PUMP, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_WILL_O_WISP, MOVE_FLAMETHROWER, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 38,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SOFT_BOILED, MOVE_SING, MOVE_EGG_BOMB, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Juan2[] = {
    ...
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_CONFUSION, MOVE_CALM_MIND, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Juan3[] = {
    ...
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Jake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_ICE_BEAM, MOVE_SURF, MOVE_PERISH_SONG, MOVE_REST
    },
    {
    .iv = 255,
    .lvl = 41,
...
static const struct TrainerMonItemCustomMoves sParty_Charles[] = {
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_POLITOED,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SURF, MOVE_HYPNOSIS, MOVE_ICE_BEAM, MOVE_COUNTER
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_EARTHQUAKE, MOVE_ICE_BEAM, MOVE_REST, MOVE_CURSE
    },
    {
    .iv = 255,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Frank[] = {
    ...
    .species = SPECIES_LAPRAS,
    .heldItem = ITEM_NONE,
    .moves = MOVE_ICE_BEAM, MOVE_ROAR, MOVE_HEAL_BELL, MOVE_THUNDERBOLT
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_SURF, MOVE_THUNDER_WAVE, MOVE_FIRE_BLAST, MOVE_SUBSTITUTE
    },
};

static const struct TrainerMonItemCustomMoves sParty_Kenny[] = {
    {
    .iv = 255,
    .lvl = 44,
    .species = SPECIES_GYARADOS,
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SURF, MOVE_LEECH_SEED, MOVE_SYNTHESIS, MOVE_PROTECT
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Chance[] = {
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_MILOTIC,
